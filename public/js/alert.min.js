...
var notie = function(){
    ...
    var alert_color_error_background = 'rgba(42,157,218,.87)';
    ...
    var alert_img_id = 'notie-alert-text';
    ...
    alert_img.setAttribute('src','/img/wrong-icon.png');
    alert_text.id = alert_text_id;
    alert_text.style.color = alert_color_text;
    alert_text.style.display = "inline-block";
    alert_text.style.verticalAlign = "middle";
    ...
    alert_img.style.display = "inline-block";
    alert_img.style.marginRight = "40px";
    alert_img.style.verticalAlign = "middle";
    ...
    function alert_show(type, message, seconds) {
        ...
        switch(type) {
            ...
            case 3:
                ...
                alert_inner.insertBefore(alert_img,alert_text);
                break;
            case 4:
