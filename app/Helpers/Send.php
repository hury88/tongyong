...
class Send
{
     ...
     */
	public static function mail($mailbox, $subject, $body){
		$smtp_server  = env('MAIL_HOST', 'smtp.126.com');
		$smtp_user    = env('MAIL_USERNAME', 'jiygora@126.com');
		$smtp_pwd     = env('MAIL_PASSWORD', 'semJiygo88');   //您登录smtp服务器的密码
		$smtp_subject = $subject;	//标题
		$smtp_body    = $body;	//内容
