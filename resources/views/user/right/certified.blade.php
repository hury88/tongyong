<?php extract($user) ?>@if($user['certified_status'] == 2)
<a class="approved" href="javascript:;">实名认证</a>
    <h3>实名认证</h3>
</div>
<div class="authentication-guide">
    <img src="/img/ren-pass.png"/>
    <div class="guide-div">
        <p class="guide-title">
            已通过实名认证
        </p>
        <p class="guide-content">很高兴认识你，现在您可以享受更多的优惠及保障</p>
    </div>
</div>
<div class="nation-edu-right-box">
    <div class="user-authentication">
        ...
        <ul class="identity-information">
            <li class="identity-information-li clearfix">
                <span class="identity-information-left fl">真实姓名：</span>
                <div class="identity-information-right fr">{{$real_name}}</div>
            </li>
            <li class="identity-information-li clearfix">
                <span class="identity-information-left fl">性别：</span>
                <div class="identity-information-right fr">{{$gendar}}</div>
            </li>
            <li class="identity-information-li clearfix">
                <span class="identity-information-left fl">出生日期：</span>
                <div class="identity-information-right fr">{{$birthday}}</div>
            </li>
            <li class="identity-information-li clearfix">
                <span class="identity-information-left fl">身份证号：</span>
                <div class="identity-information-right fr">{{$card}}</div>
            </li>
            <li class="identity-information-li clearfix">
                <div class="identity-information-right fr">
                    <div class="identity-information-img fl">
                        <img width="225" src="{{img($card_front)}}"/>
                    </div>
                    <div class="identity-information-img fl">
                        <img width="225" src="{{img($card_back)}}"/>
                    </div>
                </div>
            </li>
        </ul>
...
@elseif($certified_status == 1)
<a class="approved" href="javascript:;">认证审核中</a>
    <h3>实名认证</h3>
</div>
<div class="authentication-guide">
    <div class="guide-div">
        ...
        <p class="guide-content">实名认证审核中</p>
    </div>
</div>
<div class="nation-edu-right-box">
    <div class="user-authentication">
...
@elseif($certified_status == 0 || $certified_status == 3)
