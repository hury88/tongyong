...
@section('register_header')
    ...
    <a style="color:red" class="register-cate fr" href="{{u('register', 'org')}}{{$_r0_}}"><img src="/img/qiye.png"/>我是企业</a>
    <a class="register-cate fr" href="{{u('register', 'person')}}{{$_r0_}}"><img src="/img/student.png"/>我是学生</a>
